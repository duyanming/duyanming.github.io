...
### 2. 添加Nuget包
>```shell
 dotnet add package Anno.Rpc.Server --version 1.0.3.3
 dotnet add package Anno.EngineData --version 1.0.3.3
 ```
...
&nbsp;&nbsp;` dotnet add package Anno.Rpc.Server --version 1.0.3.3` 为Thrift方式

&nbsp;&nbsp;`dotnet add package Anno.Rpc.ClientGrpc --version 1.0.3.3` 为Grpc方式
:::
