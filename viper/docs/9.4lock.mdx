...
{  
 ...
 ![](https://www.showdoc.com.cn/server/api/attachment/visitfile/sign/e480dd71eada56958ccf04719434643e)
...
namespace ConsoleTest
{
 ...
 ```
 ![](https://www.showdoc.com.cn/server/api/attachment/visitfile/sign/9925b4d24c46255d8bf7eed6756d61c9)
 ...
 var task = Task.Factory.StartNew(() => { DLTest1("Anno"); });
                ...
                ts.Add(taskJJ);
 ```
 ![](https://www.showdoc.com.cn/server/api/attachment/visitfile/sign/7cdaa35769a5dd229082efc6429714ae)
